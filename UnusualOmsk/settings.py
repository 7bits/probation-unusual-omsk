# Django settings for UnusualOmsk project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'UnusualOmsk.sqlite',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, 'static/images_places')
...
SECRET_KEY = 'sxgl9&xa+=k6q%2f8hdpg__injfuw_m+lgnyn=&obxrmqt8@sg'
